...
public class TeamListActivityModule {
    ...
    @Provides
    TeamListViewModel provideMainViewModel(NBARepository repository, AppExecutors appExecutors) {
        return new TeamListViewModel(repository, appExecutors);
    }

    @Provides
    TeamsAdapter providesTeamsAdapter() {
